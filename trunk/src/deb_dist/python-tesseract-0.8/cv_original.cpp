...
struct cvrng_t {
 ...
 int is_cvmatnd(PyObject *o);
 int convert_to_CvArr(PyObject *o, CvArr **dst, const char *name = "no_name");
 int convert_to_IplImage(PyObject *o, IplImage **dst, const char *name = "no_name");
 int convert_to_CvMat(PyObject *o, CvMat **dst, const char *name = "no_name");
 int convert_to_CvMatND(PyObject *o, CvMatND **dst, const char *name = "no_name");
...
/* These get/setters are polymorphic, used in both iplimage and cvmat */
 ...
 PyObject *PyObject_FromCvScalar(CvScalar s, int type)
{
 ...
 PyObject *cvarr_GetItem(PyObject *o, PyObject *key);
 int cvarr_SetItem(PyObject *o, PyObject *key, PyObject *v);

// o is a Python string or buffer object.  Return its size.

 Py_ssize_t what_size(PyObject *o)
{
  void *buffer;
...
/* iplimage */
 ...
 void iplimage_dealloc(PyObject *self)
{
 ...
 PyObject *iplimage_repr(PyObject *self)
{
 ...
 PyObject *iplimage_tostring(PyObject *self, PyObject *args)
{
  iplimage_t *pc = (iplimage_t*)self;
  IplImage *i;
 ...
 struct PyMethodDef iplimage_methods[] =
{
  {"tostring", iplimage_tostring, METH_VARARGS},
  {NULL,          NULL}
};

 PyObject *iplimage_getnChannels(iplimage_t *cva)
{
  return PyInt_FromLong(((IplImage*)(cva->a))->nChannels);
}
 PyObject *iplimage_getwidth(iplimage_t *cva)
{
  return PyInt_FromLong(((IplImage*)(cva->a))->width);
}
 PyObject *iplimage_getheight(iplimage_t *cva)
{
  return PyInt_FromLong(((IplImage*)(cva->a))->height);
}
 PyObject *iplimage_getdepth(iplimage_t *cva)
{
  return PyLong_FromUnsignedLong((unsigned)((IplImage*)(cva->a))->depth);
}
 PyObject *iplimage_getorigin(iplimage_t *cva)
{
  return PyInt_FromLong(((IplImage*)(cva->a))->origin);
}
 void iplimage_setorigin(iplimage_t *cva, PyObject *v)
{
  ((IplImage*)(cva->a))->origin = PyInt_AsLong(v);
}

 PyGetSetDef iplimage_getseters[] = {
 ...
 PyMappingMethods iplimage_as_map = {
  NULL,
  &cvarr_GetItem,
  &cvarr_SetItem,
};

 PyTypeObject iplimage_Type = {
...
/* cvmat */
 ...
 void cvmat_dealloc(PyObject *self)
{
 ...
 PyObject *cvmat_repr(PyObject *self)
{
 ...
 PyObject *cvmat_tostring(PyObject *self, PyObject *args)
{
  CvMat *m;
 ...
 struct PyMethodDef cvmat_methods[] =
{
  {"tostring", cvmat_tostring, METH_VARARGS},
  {NULL,          NULL}
};

 PyObject *cvmat_gettype(cvmat_t *cva)
{
  return PyInt_FromLong(cvGetElemType(cva->a));
}

 PyObject *cvmat_getstep(cvmat_t *cva)
{
 ...
 PyObject *cvmat_getrows(cvmat_t *cva)
{
 ...
 PyObject *cvmat_getcols(cvmat_t *cva)
{
  return PyInt_FromLong(cva->a->cols);
}

 PyGetSetDef cvmat_getseters[] = {
 ...
 PyMappingMethods cvmat_as_map = {
  NULL,
  &cvarr_GetItem,
  &cvarr_SetItem,
};

 PyTypeObject cvmat_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 int is_cvmat(PyObject *o)
{
  ...
  PyObject* to = PyObject_Type(o);
  const char* tp_name = ((PyTypeObject*) to)->tp_name;
  printf("is_icvmat: %s, %d\n", tp_name, strcmp(tp_name, "numpy.ndarray") == 0);
  return strcmp(tp_name, "numpy.ndarray") >= 0;
  //return PyType_IsSubtype(o->ob_type, &iplimage_Type);
...
/* cvmatnd */
 ...
 void cvmatnd_dealloc(PyObject *self)
{
 ...
 PyObject *cvmatnd_repr(PyObject *self)
{
 ...
 PyObject *cvmatnd_tostring(PyObject *self, PyObject *args)
{
  CvMatND *m;
 ...
 struct PyMethodDef cvmatnd_methods[] =
{
  {"tostring", cvmatnd_tostring, METH_VARARGS},
  {NULL,          NULL}
};

 PyMappingMethods cvmatnd_as_map = {
  NULL,
  &cvarr_GetItem,
  &cvarr_SetItem,
};

 PyTypeObject cvmatnd_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
...
/* cvhistogram */
 ...
 void cvhistogram_dealloc(PyObject *self)
{
 ...
 PyObject *cvhistogram_getbins(cvhistogram_t *cvh)
{
  Py_INCREF(cvh->bins);
  return cvh->bins;
}

 PyGetSetDef cvhistogram_getseters[] = {
  {(char*)"bins", (getter)cvhistogram_getbins, (setter)NULL, (char*)"bins", NULL},
  {NULL}  /* Sentinel */
};

 void cvhistogram_specials(void)
{
...
/* cvlineiterator */
 ...
 PyObject *cvlineiterator_iter(PyObject *o)
{
  Py_INCREF(o);
  return o;
}

 PyObject *cvlineiterator_next(PyObject *o)
{
 ...
 PyTypeObject cvlineiterator_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvlineiterator_specials(void)
{
...
/* memtrack */
 ...
 void memtrack_dealloc(PyObject *self)
{
...
/* iplconvkernel */
 ...
 void iplconvkernel_dealloc(PyObject *self)
{
 ...
 PyTypeObject iplconvkernel_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void iplconvkernel_specials(void)
{
...
/* cvcapture */
 ...
 void cvcapture_dealloc(PyObject *self)
{
...
/* cvvideowriter */
 ...
 void cvvideowriter_dealloc(PyObject *self)
{
 ...
 PyTypeObject cvvideowriter_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvvideowriter_specials(void)
{
...
/* cvmemstorage */
 ...
 void cvmemstorage_dealloc(PyObject *self)
{
 ...
 PyTypeObject cvmemstorage_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvmemstorage_specials(void)
{
...
/* cvfont */
 ...
 void cvfont_specials(void) { }

/************************************************************************/

/* cvpositobject */

 void cvpositobject_dealloc(PyObject *self)
{
 ...
 PyTypeObject cvpositobject_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvpositobject_specials(void)
{
...
/* cvhaarclassifiercascade */
 ...
 PyTypeObject cvhaarclassifiercascade_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvhaarclassifiercascade_specials(void) { }

/************************************************************************/

/* cvcontourtree */

 PyTypeObject cvcontourtree_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 void cvcontourtree_specials(void) { }
...
/* cvsubdiv2dedge */
 ...
 PyTypeObject cvsubdiv2dedge_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 int cvsubdiv2dedge_compare(PyObject *o1, PyObject *o2)
{
 ...
 PyObject *cvquadedge_repr(PyObject *self)
{
 ...
 void cvsubdiv2dedge_specials(void) {
 ...
 void cvseq_dealloc(PyObject *self)
{
 ...
 PyObject *cvseq_h_next(PyObject *self, PyObject *args);
 PyObject *cvseq_h_prev(PyObject *self, PyObject *args);
 PyObject *cvseq_v_next(PyObject *self, PyObject *args);
 PyObject *cvseq_v_prev(PyObject *self, PyObject *args);

 struct PyMethodDef cvseq_methods[] =
{
 ...
 Py_ssize_t cvseq_seq_length(PyObject *o)
{
  cvseq_t *ps = (cvseq_t*)o;
  return (Py_ssize_t)(ps->a->total);
}

 PyObject* cvseq_seq_getitem(PyObject *o, Py_ssize_t i)
{
  cvseq_t *ps = (cvseq_t*)o;
  CvPoint *pt;
  struct pointpair{
 ...
 PyObject* cvseq_map_getitem(PyObject *o, PyObject *item)
{
  cvseq_t *ps = (cvseq_t*)o;
  if (PyInt_Check(item)) {
...
PySequenceMethods cvseq_sequence = {
 ...
 PyMappingMethods cvseq_mapping = {
  cvseq_seq_length,
  cvseq_map_getitem,
  NULL,
};

 PyTypeObject cvseq_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
...
#define MK_ACCESSOR(FIELD) \
 PyObject *cvseq_##FIELD(PyObject *self, PyObject *args) \
{ \
  cvseq_t *ps = (cvseq_t*)self; \
  CvSeq *s = ps->a; \
  if (s->FIELD == NULL) { \
...
/* cvset */
 ...
 void cvset_dealloc(PyObject *self)
{
 ...
 PyObject *cvset_iter(PyObject *o)
{
  Py_INCREF(o);
 ...
 PyObject *cvset_next(PyObject *o)
{
  cvset_t *ps = (cvset_t*)o;
...
/* cvsubdiv2d */
 ...
 PyObject *cvsubdiv2d_getattro(PyObject *o, PyObject *name)
{
...
/* cvsubdiv2dpoint */
 ...
 PyTypeObject cvsubdiv2dpoint_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,                                      /*size*/
 ...
 PyObject *cvsubdiv2dpoint_getattro(PyObject *o, PyObject *name)
{
 ...
 void cvsubdiv2dpoint_specials(void)
{
...
/* convert_to_X: used after PyArg_ParseTuple in the generated code  */
 ...
 int convert_to_char(PyObject *o, char *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvMemStorage(PyObject *o, CvMemStorage **dst, const char *name = "no_name")
{
 ...
 int convert_to_CvSeq(PyObject *o, CvSeq **dst, const char *name = "no_name")
{
 ...
 int convert_to_CvSize(PyObject *o, CvSize *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvScalar(PyObject *o, CvScalar *s, const char *name = "no_name")
{
 ...
 int convert_to_CvPointPTR(PyObject *o, CvPoint **p, const char *name = "no_name")
{
  if (!PySequence_Check(o))
 ...
 int convert_to_CvPoint2D32fPTR(PyObject *o, CvPoint2D32f **p, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
 ...
 int convert_to_CvPoint3D32fPTR(PyObject *o, CvPoint3D32f **p, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
 ...
 int convert_to_CvStarDetectorParams(PyObject *o, CvStarDetectorParams *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvRect(PyObject *o, CvRect *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvRectPTR(PyObject *o, CvRect **dst, const char *name = "no_name")
{
  *dst = new CvRect;
  if (!PyArg_ParseTuple(o, "iiii", &(*dst)->x, &(*dst)->y, &(*dst)->width, &(*dst)->height))
    return failmsg("CvRect argument '%s' expects four integers", name);
 ...
 int convert_to_CvSlice(PyObject *o, CvSlice *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvPoint(PyObject *o, CvPoint *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvPoint2D32f(PyObject *o, CvPoint2D32f *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvPoint3D32f(PyObject *o, CvPoint3D32f *dst, const char *name = "no_name")
{
 ...
 int convert_to_IplImage(PyObject *o, IplImage **dst, const char *name)
{
 ...
 int convert_to_CvMat(PyObject *o, CvMat **dst, const char *name)
{
  cvmat_t *m = (cvmat_t*)o;
  void *buffer;
  Py_ssize_t buffer_len;
 ...
 int convert_to_CvMatND(PyObject *o, CvMatND **dst, const char *name)
{
 ...
 int convert_to_CvArr(PyObject *o, CvArr **dst, const char *name)
{
  if (o == Py_None) {
    *dst = (void*)NULL;
    return 1;
 ...
 int convert_to_CvHistogram(PyObject *o, CvHistogram **dst, const char *name = "no_name")
{
...
struct pts_npts_contours {
 ...
 int convert_to_pts_npts_contours(PyObject *o, pts_npts_contours *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct cvarrseq {
 ...
 int convert_to_cvarrseq(PyObject *o, cvarrseq *dst, const char *name = "no_name")
{
  if (PyType_IsSubtype(o->ob_type, &cvseq_Type)) {
...
struct cvarr_count {
 ...
 int convert_to_cvarr_count(PyObject *o, cvarr_count *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct intpair
{
 ...
 int convert_to_intpair(PyObject *o, intpair *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct cvpoint2d32f_count {
 ...
 int convert_to_cvpoint2d32f_count(PyObject *o, cvpoint2d32f_count *dst, const char *name = "no_name")
{
  if (PyInt_Check(o)) {
...
struct floats {
 ...
 int convert_to_floats(PyObject *o, floats *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct CvPoints {
 ...
 int convert_to_CvPoints(PyObject *o, CvPoints *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct CvPoint3D32fs {
 ...
 int convert_to_CvPoint3D32fs(PyObject *o, CvPoint3D32fs *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct CvPoint2D32fs {
 ...
 int convert_to_CvPoint2D32fs(PyObject *o, CvPoint2D32fs *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct ints {
 ...
 int convert_to_ints(PyObject *o, ints *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct ints0 {
 ...
 int convert_to_ints0(PyObject *o, ints0 *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
...
struct dims
{
 ...
 int convert_to_dim(PyObject *item, int i, dims *dst, CvArr *cva, const char *name = "no_name")
{
 ...
 int convert_to_dims(PyObject *o, dims *dst, CvArr *cva, const char *name = "no_name")
{
  if (!PyTuple_Check(o)) {
    dst->count = 1;
...
struct IplImages {
 ...
 int convert_to_IplImages(PyObject *o, IplImages *dst, const char *name = "no_name")
{
...
struct CvArrs {
 ...
 int convert_to_CvArrs(PyObject *o, CvArrs *dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
 ...
 int convert_to_floatPTRPTR(PyObject *o, float*** dst, const char *name = "no_name")
{
  PyObject *fi = PySequence_Fast(o, name);
  if (fi == NULL)
    return 0;
 ...
 int convert_to_IplConvKernelPTR(PyObject *o, IplConvKernel** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvCapturePTR(PyObject *o, CvCapture** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvVideoWriterPTR(PyObject *o, CvVideoWriter** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvMomentsPTR(PyObject *o, CvMoments** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvFontPTR(PyObject *o, CvFont** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvHaarClassifierCascadePTR(PyObject *o, CvHaarClassifierCascade** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvContourTreePTR(PyObject *o, CvContourTree** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvPOSITObjectPTR(PyObject *o, CvPOSITObject** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvRNGPTR(PyObject *o, CvRNG** dst, const char *name = "no_name")
{
...
typedef void* generic;
 int convert_to_generic(PyObject *o, generic *dst, const char *name = "no_name")
{
 ...
 int convert_to_CvTermCriteria(PyObject *o, CvTermCriteria* dst, const char *name = "no_name")
{
 ...
 int convert_to_CvBox2D(PyObject *o, CvBox2D* dst, const char *name = "no_name")
{
 ...
 int convert_to_CvSubdiv2DPTR(PyObject *o, CvSubdiv2D** dst, const char *name = "no_name")
{
 ...
 int convert_to_CvNextEdgeType(PyObject *o, CvNextEdgeType *dst, const char *name = "no_name")
{
  if (!PyNumber_Check(o)) {
 ...
 int convert_to_CvSubdiv2DEdge(PyObject *o, CvSubdiv2DEdge *dst, const char *name = "no_name")
{
...
/************************************************************************/
 ...
 PyObject *pythonize_CvMat(cvmat_t *m)
{
 ...
 PyObject *pythonize_IplImage(iplimage_t *cva)
{
 ...
 PyObject *pythonize_CvMatND(cvmatnd_t *m)
{
  //
...
#define FROM_CvPoint2D64f(r) Py_BuildValue("(ff)", r.x, r.y)
 ...
 PyObject *_FROM_CvSeqPTR(CvSeq *s, PyObject *storage)
{
 ...
 PyObject *_FROM_CvSubdiv2DPTR(CvSubdiv2D *s, PyObject *storage)
{
 ...
 PyObject *FROM_chars(chars r)
{
 ...
 PyObject *FROM_cvpoint2d32f_count(cvpoint2d32f_count r)
{
  PyObject *pr;
 ...
 PyObject *FROM_CvPoint2D32fs(CvPoint2D32fs r)
{
  PyObject *pr;
...
typedef CvSeq CvSeqOfCvConvexityDefect;
 PyObject *FROM_CvSeqOfCvConvexityDefectPTR(CvSeqOfCvConvexityDefect *r)
{
  PyObject *pr;
...
typedef CvSeq CvSeqOfCvAvgComp;
 PyObject *FROM_CvSeqOfCvAvgCompPTR(CvSeqOfCvAvgComp *r)
{
  PyObject *pr;
  pr = PyList_New(r->total);
  for (int i = 0; i < r->total; i++) {
...
typedef CvSeq CvSeqOfCvStarKeypoint;
 PyObject *FROM_CvSeqOfCvStarKeypointPTR(CvSeqOfCvStarKeypoint *r)
{
  PyObject *pr;
  pr = PyList_New(r->total);
  for (int i = 0; i < r->total; i++) {
...
typedef CvSeq CvSeqOfCvSURFPoint;
 PyObject *FROM_CvSeqOfCvSURFPointPTR(CvSeqOfCvSURFPoint *r)
{
  PyObject *pr;
  pr = PyList_New(r->total);
  for (int i = 0; i < r->total; i++) {
...
typedef CvSeq CvSeqOfCvSURFDescriptor;
 PyObject *FROM_CvSeqOfCvSURFDescriptorPTR(CvSeqOfCvSURFDescriptor *r)
{
  PyObject *pr;
  pr = PyList_New(r->total);
  for (int i = 0; i < r->total; i++) {
 ...
 PyObject *FROM_IplConvKernelPTR(IplConvKernel *r)
{
 ...
 PyObject *FROM_CvCapturePTR(CvCapture *r)
{
 ...
 PyObject *FROM_CvVideoWriterPTR(CvVideoWriter *r)
{
...
typedef CvPoint2D32f CvPoint2D32f_4[4];
 PyObject *FROM_CvPoint2D32f_4(CvPoint2D32f* r)
{
...
typedef float CvMatr32f_i[9];
 ...
 PyObject *FROM_CvMatr32f_i(CvMatr32f_i r)
{
...
typedef float CvVect32f_i[3];
 PyObject *FROM_CvVect32f_i(CvVect32f_i r)
{
  return Py_BuildValue("fff",
    r[0], r[1], r[2]);
}

 PyObject *FROM_CvFont(CvFont r)
{
 ...
 PyObject *FROM_CvSubdiv2DPointPTR(CvSubdiv2DPoint* r)
{
  if (r != NULL) {
 ...
 PyObject *FROM_IplImagePTR(IplImage *r)
{
 ...
 PyObject *FROM_ROIplImagePTR(ROIplImage *r)
{
  if (r != NULL) {
    iplimage_t *cva = PyObject_NEW(iplimage_t, &iplimage_Type);
 ...
 PyObject *FROM_CvMatPTR(CvMat *r)
{
 ...
 PyObject *FROM_CvMat(CvMat *r)
{
 ...
 PyObject *FROM_CvMatNDPTR(CvMatND *r)
{
 ...
 PyObject *FROM_CvPOSITObjectPTR(CvPOSITObject *r)
{
 ...
 PyObject *FROM_CvRNG(CvRNG r)
{
 ...
 PyObject *FROM_CvHaarClassifierCascade(CvHaarClassifierCascade *r)
{
 ...
 PyObject *FROM_CvMoments(CvMoments r)
{
 ...
 PyObject *FROM_CvContourTreePTR(CvContourTree *r)
{
 ...
 PyObject *FROM_generic(generic r)
{
 ...
 PyObject *FROM_CvSubdiv2DEdge(CvSubdiv2DEdge r)
{
 ...
 * so are handwritten here */
 ...
 PyObject *pycvWaitKey(PyObject *self, PyObject *args, PyObject *kw)
{
  int delay = 0;
 ...
 PyObject *pycvLoadImage(PyObject *self, PyObject *args, PyObject *kw)
{
 ...
 PyObject *pycvCreateImageHeader(PyObject *self, PyObject *args)
{
 ...
 PyObject *pycvCreateImage(PyObject *self, PyObject *args)
{
  int w, h, depth, channels;
 ...
 PyObject *pycvCreateMatHeader(PyObject *self, PyObject *args)
{
  int rows, cols, type;
 ...
 PyObject *pycvCreateMat(PyObject *self, PyObject *args)
{
  int rows, cols, type;
  if (!PyArg_ParseTuple(args, "iii", &rows, &cols, &type))
    return NULL;
 ...
 PyObject *pycvCreateMatNDHeader(PyObject *self, PyObject *args)
{
  ints dims;
  int type;
 ...
 PyObject *pycvCreateMatND(PyObject *self, PyObject *args)
{
  ints dims;
  int type;
 ...
 PyObject *pycvCreateHist(PyObject *self, PyObject *args)
{
  PyObject *dims;
  int type;
  float **ranges = NULL;
 ...
 PyObject *pycvInitLineIterator(PyObject *self, PyObject *args)
{
  CvArr *image;
  CvPoint pt1;
  CvPoint pt2;
 ...
 PyObject *pycvCreateMemStorage(PyObject *self, PyObject *args)
{
  int block_size = 0;
 ...
 int cvarr_SetItem(PyObject *o, PyObject *key, PyObject *v)
{
 ...
 PyObject *pycvSetData(PyObject *self, PyObject *args)
{
  PyObject *o, *s;
  int step = -1;
 ...
 PyObject *what_data(PyObject *o)
{
 ...
 PyObject *pycvCreateData(PyObject *self, PyObject *args)
{
  PyObject *o;
 ...
 PyObject *pycvGetDims(PyObject *self, PyObject *args)
{
  PyObject *o;
 ...
 PyObject *pycvGetImage(PyObject *self, PyObject *args)
{
  PyObject *o, *r;
 ...
 PyObject *pycvGetMat(PyObject *self, PyObject *args)
{
  PyObject *o, *r;
 ...
 PyObject *pycvReshape(PyObject *self, PyObject *args)
{
  PyObject *o;
  int new_cn;
  int new_rows = 0;
 ...
 void OnMouse(int event, int x, int y, int flags, void* param)
{
 ...
 PyObject *pycvSetMouseCallback(PyObject *self, PyObject *args, PyObject *kw)
{
...
void OnChange(int pos, void *param)
{
 ...
 PyObject *pycvCreateTrackbar(PyObject *self, PyObject *args, PyObject *kw)
{
 ...
 PyObject *pycvFindContours(PyObject *self, PyObject *args, PyObject *kw)
{
  CvArr* image;
 ...
 PyObject *pycvApproxPoly(PyObject *self, PyObject *args, PyObject *kw)
{
  cvarrseq src_seq;
 ...
 float distance_function_glue( const float* a, const float* b, void* user_param )
{
 ...
 PyObject *pycvCalcEMD2(PyObject *self, PyObject *args, PyObject *kw)
{
 ...
 PyObject *pycvSubdiv2DLocate(PyObject *self, PyObject *args)
{
 ...
 PyObject *pycvCalcOpticalFlowPyrLK(PyObject *self, PyObject *args)
{
  CvArr* prev;
 ...
 PyObject *pycvClipLine(PyObject *self, PyObject *args, PyObject *kw)
{
  CvSize img_size;
 ...
 PyObject *temp_test(PyObject *self, PyObject *args)
{
#if 0
 ...
 PyObject *pycvFindChessboardCorners(PyObject *self, PyObject *args, PyObject *kw)
{
  CvArr* image;
  PyObject *pyobj_image = NULL;
  CvSize pattern_size;
...
// and manage reference counts.
 ...
 void preShareData(CvArr *donor, CvMat **recipient)
{
  *recipient = cvCreateMatHeader(4, 4, cvGetElemType(donor));
}

 PyObject *shareData(PyObject *donor, CvArr *pdonor, CvMat *precipient)
{
 ...
 PyObject *pycvGetHuMoments(PyObject *self, PyObject *args, PyObject *kw)
{
  CvMoments* moments;
 ...
 PyObject *pycvFitLine(PyObject *self, PyObject *args, PyObject *kw)
{
  cvarrseq points;
 ...
 PyObject *pycvGetMinMaxHistValue(PyObject *self, PyObject *args, PyObject *kw)
{
  CvHistogram* hist;
 ...
 CvSeq* cvHOGDetectMultiScale( const CvArr* image, CvMemStorage* storage,
