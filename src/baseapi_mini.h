...
//..__<<numof()=0>><<COMMENTING=0>>	typedef float (Dict::*ParamsModelClassifyFunc)(//................<typedef float (Dict::*ParamsModelClassifyFunc)(>//..__<<numof()=0>><<COMMENTING=0>>	typedef float (Dict::*ParamsModelClassifyFunc)(
//..__<<numof()=0>><<COMMENTING=10000>>	const char *lang, void *path);
...
* as UTF8 and must be freed with the delete [] operator.
*/
//..__<<numof()=0>><<COMMENTING=0>>	char* GetUTF8Text();
